# NBJM/1 — Notion Is Basically Just Markdown, version 1
...
## Solution: NBJM Format (Notion Is Basically Just Markdown)
...
NBJM parsing uses a **state machine** with three contexts:
...
| Scenario | API JSON | NBJM | Savings |
|:---------|:---------|:----|:--------|
